...
for iii in (select to_date('20170115', 'YYYYMMDD') tmpdate from dual
union
select to_date('20170215', 'YYYYMMDD')  from dual
union
select to_date('20170315', 'YYYYMMDD')  from dual
union
select to_date('20170415', 'YYYYMMDD')  from dual
union
select to_date('20170515', 'YYYYMMDD')  from dual
union
select to_date('20170615', 'YYYYMMDD')  from dual
union
select to_date('20170715', 'YYYYMMDD')  from dual
union
select to_date('20170815', 'YYYYMMDD')  from dual
union
select to_date('20170915', 'YYYYMMDD')  from dual
union
select to_date('20171015', 'YYYYMMDD')  from dual
union
select to_date('20171115', 'YYYYMMDD')  from dual
union
select to_date('20171215', 'YYYYMMDD')  from dual
union  
select to_date('20180115', 'YYYYMMDD')  from dual
union
select last_day(to_date('20180115', 'YYYYMMDD'))  from dual
union
select to_date('20180215', 'YYYYMMDD')  from dual
union
select last_day(to_date('20180215', 'YYYYMMDD'))  from dual
union
select to_date('20180315', 'YYYYMMDD')  from dual
union
select last_day(to_date('20180315', 'YYYYMMDD'))  from dual
union
select to_date('20180415', 'YYYYMMDD')  from dual
union
select last_day(to_date('20180415', 'YYYYMMDD'))  from dual
union
...
--poszerzenie wielkości szerokości kolumn w poszczególnych tabelach
/*
declare
  len number;
begin
